...
extension PierScene{
    ...
    private func buildDialogues(){
       dialogos = [
        ...
        DialogueBox(mensagem: "… Excuse me, miss.", mensageiro: anna),
        ...
        DialogueBox(mensagem: "I'm sorry for interrupting you, miss. Yes, I'm detective anna.", mensageiro: anna),
        DialogueBox(mensagem: "Ahem, I just wanted to ask some questions about…", mensageiro: anna),
        DialogueBox(mensagem: "…The murder case, yes?", mensageiro: suspect),
        DialogueBox(mensagem: "Right. I'm sorry, I suppose it's better if I get straight to the point…", mensageiro: anna),
        DialogueBox(mensagem: "You are Elena Brooke, correct?", mensageiro: anna),
        DialogueBox(mensagem: "Yes… Yes I am.", mensageiro: suspect),
       ]
        suspect.name = "Elena Brooke"
        dialogos.append(contentsOf: [
        DialogueBox(mensagem: "Then, miss, I'm sure you must be tired from having to talk about this but… Could I bother you to answer a few questions about this case?", mensageiro: anna),
        DialogueBox(mensagem: "… Of course, officer. I'll help how I can.", mensageiro: suspect),
        DialogueBox(mensagem: "Again, I'm so sorry Mrs. Brooke. For your loss, and for having to put you through this…", mensageiro: anna),
        DialogueBox(mensagem: "But I promise that ,if you let me, I'll do everything and anything I can to bring your husband justice.", mensageiro: anna),
        ...
        DialogueBox(mensagem: "… Then, Mrs. Brooke. Let's start. I'll try not to take much of your time.", mensageiro: anna),
        //Beginning Phase 1
        DialogueBox(mensagem: "Ma'am, can you start by telling me what you know about the case?", mensageiro: anna), //20
        ...
        DialogueBox(mensagem: "That's understandable, ma'am, don't worry.", mensageiro: anna),
        DialogueBox(mensagem: "… Could you tell me more about how he was found? You've mentioned the fishing net and the pocket knife, was there anything else?", mensageiro: anna),
        ...
        DialogueBox(mensagem: "I see…", mensageiro: anna),
        DialogueBox(mensagem: "Alright… Mrs. Brooke, could you also tell me about that night specifically?", mensageiro: anna),
        DialogueBox(mensagem: "… What about it, officer?", mensageiro: suspect),
        DialogueBox(mensagem: "Well, what you were doing, or if you knew where your husband had been before… all this took place…", mensageiro: anna),
        ...
        DialogueBox(mensagem: "Huh… Excuse me, Mrs. Brooke, but what was the relationship between you and Mr. Brooke like?", mensageiro: anna),
        DialogueBox(mensagem: "I'm sorry…?", mensageiro: suspect),
        DialogueBox(mensagem: "Well, it's just that, from what you've said, it seems like you weren't really that close… Was it always like that?", mensageiro: anna),
    ...
    func choice1Selected(){
        if phase == 1{
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "Well, Mrs. Brooke… I don't mean to overstep any boundaries, but I'm just saying that if he was, by any chance, a bad husband–", mensageiro: anna),
                ...
                DialogueBox(mensagem: "I didn't mean to assume, Mrs. Brooke. My apologies… That was insensitive of me.", mensageiro: anna),
                ...
                DialogueBox(mensagem: "Of course.", mensageiro: anna)
            ])
            dialogueCount += 10
            phase2Dialogues()
            phase += 1
            ...
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "… Mrs. Brooke. I don't know how you will receive this, but I really need to ask this… For the sake of bringing your husband justice…", mensageiro: anna),
                DialogueBox(mensagem: "Are you, by any chance, covering for someone who might be involved in the murder?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "Then, please go ahead and clarify, Mrs. Brooke.", mensageiro: anna),
                DialogueBox(mensagem: "And I'm sorry for startling you with that assumption, but I have to get rid of these kinds of possibilities if I want to solve the case…", mensageiro: anna),
                ...
                DialogueBox(mensagem: "… Mrs. Brooke?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "What do you mean by that, Mrs. Brooke…?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "That's alright, Mrs. Brooke. I can't keep you here.", mensageiro: anna),
                DialogueBox(mensagem: "And once again, I'm sorry for your loss…", mensageiro: anna),
    ...
    func choice2Selected(){
        if phase == 1 {
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "Mrs. Brooke, I apologize in advance if this comes off as rude, but… Even if you had a fight, something even bigger than just a small disagreement, as you've said…", mensageiro: anna),
                DialogueBox(mensagem: "We don't hear much about spouses turning their back on each other for days, to the point of having to hear about the other from a friend…", mensageiro: anna),
                DialogueBox(mensagem: "Not if they're genuinely close. Did you really not get worried at all about his absence? Did you really not check on him, not even once?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "It's alright, ma'am. Take your time…", mensageiro: anna),
                DialogueBox(mensagem: "*Sigh*", mensageiro: suspect),
                ...
                DialogueBox(mensagem: "Oh Elena, I'm so sorry… I'm sure he wouldn't blame you, though…", mensageiro: anna),
                DialogueBox(mensagem: "Yeah… He was too kind for that…", mensageiro: suspect),
                DialogueBox(mensagem: "… Sorry for letting myself get annad over… Do you need anything else?", mensageiro: suspect)
            ])
            phase2Dialogues()
            phase += 1
        }
            ...
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "Mrs. Elena… I’m sorry for the bluntness, but…", mensageiro: anna),
                DialogueBox(mensagem: "Are you sure you weren’t aware of Peter’s whereabouts, or his state in general, before his murder happened?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "That's not exactly what I was trying to say, ma'am… I was just wondering if you may have, perhaps indirectly, affected this in some way…", mensageiro: anna),
                ...
                DialogueBox(mensagem: "Mrs. Brooke, please–", mensageiro: anna),
                ...
                DialogueBox(mensagem: "Wait, please, Mrs. Brooke–", mensageiro: anna),
    ...
    func choice3Selected(){
        if phase == 1 {
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "I'm sorry if it sounded harsh, ma'am. I'm just wondering about his absence, that's all.", mensageiro: anna),
                DialogueBox(mensagem: "It isn't unheard of for a couple to fight and keep their distance for a while, but given the situation, I think it's fair to wonder if there's anything more to it, don't you think?", mensageiro: anna),
            ...
            dialogos.append(contentsOf: [
                ...
                DialogueBox(mensagem: "Mrs. Elena, this might be a hasty assumption on my part, but…", mensageiro: anna),
                DialogueBox(mensagem: "Are you and this friend of yours, in perhaps a more complex kind of relationship…?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "Please do, Mrs. Brooke.", mensageiro: anna),
                ...
                DialogueBox(mensagem: "… Sorry for interrupting, Mrs. Brooke, but what do you mean by that?", mensageiro: anna),
                ...
                DialogueBox(mensagem: "But–", mensageiro: anna),
                ...
                DialogueBox(mensagem: "… Well, I wish we could have kept talking for longer, but I have no power to keep you here, Mrs. Brooke. I suppose you've helped enough.", mensageiro: anna),
                DialogueBox(mensagem: "Alright… Okay… Then, goodbye, officer. Good… Good luck with the investigation.", mensageiro: suspect),
                DialogueBox(mensagem: "Goodbye, Mrs. Brooke…", mensageiro: anna)
            ])
            dialogueCount += 5
        }
        if let score = choicesNode.selectedChoice?.score{
    ...
    func phase2Dialogues(){
        dialogos.append(contentsOf: [
            //Beginning Phase 2
            DialogueBox(mensagem: "Alright. Let's proceed, then.", mensageiro: anna),
            DialogueBox(mensagem: "Mrs. Brooke, you've said earlier that you left the night of the murder to meet a friend… Could you please clarify that for me?", mensageiro: anna),
            ...
            DialogueBox(mensagem: "… Right. Is that also the same friend who let you know how he was doing during this period of absence?", mensageiro: anna),
            DialogueBox(mensagem: "I'm sorry, what do you mean?", mensageiro: suspect),
            DialogueBox(mensagem: "You mentioned you had heard from a friend that Peter seemed fine, unchanged even. Was that the same friend?", mensageiro: anna),
            DialogueBox(mensagem: "Um, I don't see how that's relevant, officer…", mensageiro: suspect),
            DialogueBox(mensagem: "Alright, Mrs. Brooke I'll be frank with you..." , mensageiro: anna),
            DialogueBox(mensagem: "I don't have much time to work on this case, and with how vague you have been with these details, I can't afford to be delicate about starting these discussions.", mensageiro: anna),
            DialogueBox(mensagem: "So, my apologies, but there must be a reason why you've mentioned this friend twice instead of anything else.", mensageiro: anna),
            ...
            DialogueBox(mensagem: "What mess, ma'am? As far as I'm aware this is no official procedure. I'm just asking a few questions in order to solve this case as quickly and fairly as possible…", mensageiro: anna),
